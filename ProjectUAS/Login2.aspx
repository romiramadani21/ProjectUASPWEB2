<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Login2.aspx.vb" Inherits="Login1" %>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					...
					<div class="wrap-input100 validate-input" data-validate = "Masukan Username Anda !">
						<asp:Textbox class="input100" type="text" ID="username" placeholder="Username" runat="server"> </asp:Textbox>
					...
					<div class="wrap-input100 validate-input" data-validate = "Masukan Password Anda !">
					 ...
					 <asp:DropDownList ID="level"  class="input100" runat="server" >
