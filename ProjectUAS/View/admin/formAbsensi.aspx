<%@ Page Title="" Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="formAbsensi.aspx.vb" Inherits="View_admin_formAbsensi" %>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Mentor</label>
                          <asp:DropDownList ID="txtNama" class="form-control" runat="server" 
							 DataSourceID="SqlDataSource2" DataTextField="nama_mentor" 
							 DataValueField="nama_mentor">
						 </asp:DropDownList>
							<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:mentoringConnectionString %>" SelectCommand="SELECT [nama_mentor] FROM [Mentor]"></asp:SqlDataSource>
                      </div>
                     <div class="form-group">
