<%@ Page Title="" Language="VB" MasterPageFile="~/Pementor.master" AutoEventWireup="false" CodeFile="formJadwal.aspx.vb" Inherits="View_pementor_formJadwal" %>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Waktu Mulai</label>
                          	    <asp:Textbox  class="form-control" type="text" ID="txtMulai" TextMode="Time" runat="server"> </asp:Textbox>
                          </div>
                           <div class="form-group">
                            <label for="exampleInputEmail1">Waktu Selesai</label>
                          	    <asp:Textbox  class="form-control" type="text" ID="txtSelesai" TextMode="Time" runat="server"> </asp:Textbox>
                          </div>   
                         <div class="form-group">
